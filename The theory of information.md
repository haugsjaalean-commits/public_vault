...
This means that every object is treated the same, just like when [factoring](https://en.wikipedia.org/wiki/Factorization) out a common denominator in algebra. We simply go through a list of steps for each object. This is different from my current base model, as my model allows the freedom to treat every object in a unique manner from all other objects.

I have created a semi-mathematical structure which resembles organization, but there are no rules defining what it *means*  to organize. I think this is a part of the theory that I could take further: different **patterns of organization**.

When I first thought about this, I wondered if I had taken the theory in the wrong direction, but what I'm currently hoping is that I actually just created a solid, purely theoretical base, onto which I can build more interesting structures.
